...
export default function DriverRegistrationForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!validatePhone(form.phone)) {
      alert("Phone must be 10 digits starting with 0 or 9 digits starting with 7.")
      return
    }
    if (!form.license_no || !validateLicense(form.license_no)) {
      alert("License number must only contain letters and numbers (no spaces or symbols).")
      return
    }
    ...
    if (!validatePassword(form.password)) {
      alert("Password must be at least 8 chars, include letters, numbers, and a special char.")
      return
    }
